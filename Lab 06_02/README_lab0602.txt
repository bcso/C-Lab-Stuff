...
Step2. Enter the list of marks of the students 
Step3. Enter -1 when you no longer have any numbers to input 
Step4. Average, and the histogram is produced 
Step5. Press any key to dismiss the program 
